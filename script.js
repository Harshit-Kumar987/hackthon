...
// ==========================================
// PHASE 4 - DOCTOR DASHBOARD & AI SUMMARY
// ==========================================
function loadDoctorDashboard() {
    ...
    if (summaryTextArea) {
        if (approvalState.summaryText) {
            ...
            summaryTextArea.value = generateAISummaryText(patient, history, doc);
        }
    }
...
function regenerateAISummary() {
    ...
    const newSummary = generateAISummaryText(patient, history, doc);
    document.getElementById("aiSummaryText").value = newSummary;
    alert("AI Summary re-synthesized based on current intake data!");
}
